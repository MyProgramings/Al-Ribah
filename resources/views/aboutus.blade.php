...
@section('content')
    ...
    <main
        style="background-image: url('images/Untitled-2.webp');height: 650px;
                ...
                <div class="col-md-12">
                    <div class="search-form">
                        <div class="about-section">
                            ...
                            <p class="m-0">يحيط بشبام التاريخية اراضي زراعية (جروب) تقدر مساحتها 160 فدان من الجهات
                                الشرقية والشمالية والغربية تروى بمياه
                                الفيضانات وقد نشأ الاجداد نظام بديع للري يمتد من سد الموزع (5كم) غربي المدينة ويمر بالساقية
                                الرئيسية (ساقية البلاد) ثم سواقي
                                فرعية تتفرع الى سواقي (قنوات) فرعية صغيرة لينساب الماء الى الجروب المحاذية للمدينة مزروعة
                                بأشجار النخيل والتي كانت
                                تمد السكان بالتمور.</p>
                        </div>
                        <div class="about-section">
                            <p>في الماضي القريب اهملت الاراضي الزراعية بسبب العوامل السياسية والاقتصادية ومن هذا المنطلق
                                أوجدت جمعية الربّة عام
                                2004 لحماية الاراضي الزراعية من الاندثار والعبث بها والحفاظ على الموروث الزراعي لمدينة شبام
                                التاريخية وكذلك الاستفادة
