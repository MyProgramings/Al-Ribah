<div class="fixed-top">
    <div style="background-color: #114f39; padding: 2px 0;">
        <div class="container">
            ...
            <p style="color: white; margin: 0;">
                ...
                &nbsp&nbsp&nbsp<a href="https://maps.app.goo.gl/oAr8cFnJFHVvayxG9" class="text-white"><i
    ...
    <nav class="navbar navbar-expand-lg" id="navbar">
        <div class="container">
            <a class="navbar-brand " id="logo_image" href="{{ route('index_blog') }}"><img src="{{ asset('logo.webp') }}" class="large-logo-show"
                    style="height: auto; max-width: 100%;" alt="logo">
                    <img src="{{ asset('small_logo.webp') }}" class="small-logo-show" style="height: auto;" alt="logo"></a>
                        ...
                        <div class="dropdown-menu text-right">
                            @foreach ($pages as $page)
                                <a class="dropdown-item"
                                    href="{{ route('page.nav.show', $page->slug) }}">{{ $page->title }}</a>
                            @endforeach
                        </div>
                    </li>
                    {{-- @auth
                    ...
                    @auth
                        @can('add-post')
                            ...
                            <li class="nav-item dropdown no-arrow alert-dropdown mx-1" style="list-style: none;">
                                <a class="nav-link dropdown-toggle dropdown-toggle-notification ms-2" href="#"
                                    id="alertsDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true"
                                    aria-expanded="false">
                                    <i class="fas fa-bell fa-fw fa-lg"></i>
                                    <!-- Counter - Alerts -->
                                    @isset(App\Models\Alert::where('user_id', Auth::user()->id)->first()->alert)
                                        <span class="badge badge-danger badge-counter notif-count rounded-circle"
                                ...
                                <div class="dropdown-list dropdown-menu dropdown-menu-right text-right mt-2 mr-auto"
                                    style="left: 0; right: auto; width: 300px;" aria-labelledby="alertsDropdown">
